<div class="container col-xl-8 py-5 my-5 border shadow-lg p-3 mb-5 bg-body-tertiary rounded" data-aos="fade-left">
        ...
        <div class="card text-center my-3">
            ...
            <?php if (!empty($dados['post']->imagem)): ?>
                    <img src="<?= URL . '/' . $dados['post']->imagem ?>" class="card-img-top img-fluid" style="max-height: 300px; object-fit: cover;" alt="Em construção">
            <?php endif; ?>
    ...
    <li class="list-inline-item">
        ...
        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDeletar<?=$dados['post']->id?>">Deletar</a>

        <!-- Modal -->
        <div class="modal fade" id="modalDeletar<?=$dados['post']->id?>" tabindex="-1" aria-labelledby="modalDeletarLabel<?=$dados['post']->id?>" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content bg-dark text-white"> 
                    <!-- Adicionando tema preto e letras brancas -->
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalDeletarLabel<?=$dados['post']->id?>">Certeza que deseja excluir?</h1>
